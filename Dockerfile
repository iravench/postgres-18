...
#
# Security: pgvector 0.8.2 fixes CVE-2026-3172 (buffer overflow in
# parallel HNSW index builds). Both extensions track Debian security
# patches automatically via apt, unlike pinned source builds.
#
...
LABEL description="PostgreSQL 18 with PostGIS 3.6.3 + pgvector 0.8.2 — apt-based"
LABEL version="1.0"
